...
requestRead.open('GET', 'http://127.0.0.1:8080/api/subject/'+id, true)
requestRead.onload = function () {
	...
	requestReadTeachers.open('GET', 'http://127.0.0.1:8080/api/teacher/', true)
	...
	buttonSave.addEventListener("click", function(){
		...
		fetch('http://127.0.0.1:8080/api/subject/'+id, {
			method: "PUT",
			body: JSON.stringify({
