...
requestRead.open('GET', 'http://127.0.0.1:8080/api/teacher/', true)
requestRead.onload = function () {
	...
	requestStudents.open("GET","http://127.0.0.1:8080/api/student/",true);
	...
	buttonSave.addEventListener("click", function(){
		...
		if(vGradeValue.length>0 && vGradeDescription.length>0 && vGradeTeacherId.length>0 && idOfSelectedStudent.length>0){
			fetch("http://127.0.0.1:8080/api/grade/", {
				method: "POST",
				body: JSON.stringify({
				gradeId: "",
			...
			readThisGradeId.open("GET","http://127.0.0.1:8080/api/grade/",true);
			readThisGradeId.onload=function(){
				...
				readSelectedStudent.open("GET","http://127.0.0.1:8080/api/student/"+idOfSelectedStudent,true);
				readSelectedStudent.onload=function(){
					...
					fetch("http://127.0.0.1:8080/api/student/"+idOfSelectedStudent,{
						method: "PUT",
						body: myjson,headers:{
							"Content-type": "application/json; charset:UTF-8"
						}
